...
Die Physik rechnet mit festen Schritten von 1/120 Sekunde. `GAP = 165`, `GRAVITY = 600`, `JUMP = 700`, `SPEED = 480`. Die Flugzeit bis zur nächsthöheren Plattform beträgt ohne Denkpause etwa 2,07 Sekunden (vorher 1,75 Sekunden). Der höhere Sprung bietet damit rund 18 Prozent mehr Flugzeit. Für die gesamte steuerbare Breite von 544 Einheiten werden rund 1,13 Sekunden benötigt; damit sind alle Plattformen auch von den Rändern erreichbar. Die Kamera wechselt nur mit der Aufgabe und hält die aktive Plattformreihe bei `ROW_Y = 350` – 50 Spieleinheiten tiefer als zuvor. Kronk bleibt auch am höchsten Punkt vollständig sichtbar.
